        ...
        <div className="contenaireDiscussion">
            <div className="listeDiscussion">
                ...
                <div className='optionDiscussion'>
                    <div  className={`recentDiscussion ${active === 'recent' ? 'active' : ''}`}  onClick={() => setActive('recent')}>
                        <img src={recent} alt="recent" />
                        <p>Récents</p>
                    </div>
                    <div className={`amisDiscussion ${active === 'amis' ? 'active' : ''}`} onClick={() => setActive('amis')}>
                        <img src={amis} alt="amis" />
                        <p>Amis</p>

                    </div>
                    <div className={`groupeDiscussion ${active === 'groupe' ? 'active' : ''}`} onClick={() => setActive('groupe')} >
            ...
            <div className="contenuDiscussion">
                ...
                <div className='sendMessage'>
                    ...
                    <div className='textMessage'>
                        <input className='inputMessage' placeholder='Entrer un message'>
